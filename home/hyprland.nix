{ config, pkgs, ... }:
{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      		 ...
      		 # Bind Super key to launch Rofi in combi mode (apps + windows)
      		 #bind = SUPER, SUPER_L, exec, rofi -show combi -combi-modi window,drun -modi combi
      		 ...
      		 monitor = ,1920x1080@120, 0x0,1,mirror, eDP-1 
      		 ...
      		 #exec-once = waypaper --wallpaper /home/max/Pictures/Wallpapers/mystical-tree.png
      		...
      		############################
      		 ...
      		 exec-once = gsettings set org.gnome.desktop.wmsss.preferences button-layout :
      		 ...
      		 exec-once = sh -c 'while true; do waybar; sleep 1; done'
      		 ...
      		 # uncomment all if you wish to use that.
      		  ...
      		  windowrulev2 = tile,class:librewolf,title:File Upload
